import type { DepartureItem, FeaturedTourApiItem } from '../types/home'
...
export async function getUpcomingDepartures(tours: FeaturedTourApiItem[]): Promise<DepartureItem[]> {
