...
import { useUpcomingDepartures } from '../hooks/useUpcomingDepartures'
...
export function UpcomingDeparturesSection({ tours }: UpcomingDeparturesSectionProps) {
  const { data, error, isLoading, refetch } = useUpcomingDepartures(tours)
