  ...
  return (
    <div className="customer-page">
      <div className="customer-page-container">
        ...
        {reviewsQuery.isError ? <Alert type="error" showIcon title={reviewsQuery.error instanceof Error ? reviewsQuery.error.message : 'Không thể tải danh sách đánh giá'} /> : null}
          ...
          <Space orientation="vertical" size={18} className="customer-page-stack">
            {reviewsQuery.data.map((review) => (
              <Card key={review.id} className="customer-booking-card" variant="borderless">
                <Space orientation="vertical" size={10} className="customer-booking-card-stack">
