...
export function AppHeader() {
  ...
  const items = [
    { key: ROUTES.home, label: <Link to={ROUTES.home}>Trang chủ</Link> },
    { key: ROUTES.about, label: <Link to={ROUTES.about}>Giới thiệu</Link> },
  ...
  const selectedKey = items.some((item) => item.key === location.pathname) ? location.pathname : ROUTES.home
